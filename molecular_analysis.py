...
from rdkit.Chem import AllChem, Draw, rdMolDescriptors, rdPartialCharges
...
def analyze_smiles_encoding(smiles, output_file=None):
    ...
    if output_file:
        ...
        print(f"Saved SMILES encoding visualization to {output_file}")
